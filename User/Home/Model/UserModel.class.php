...
class UserModel extends Model {
	...
	protected $_validate = array(
		...
		//	array('UE_qq','require','QQ必填！',1),
			...
			//array('UE_account','/^[a-zA-Z0-9]{6,15}$/','登入帐号为6-12个字符,大小写英文+数字,请勿用特殊词符！',1),
			array('UE_password','/^[a-zA-Z0-9]{6,15}$/','登入密码6-12个字符,大小写英文+数字,请勿用特殊词符！',1),

			array('UE_secpwd','/^[a-zA-Z0-9]{6,15}$/','二级密码6-12个字符,大小写英文+数字,请勿用特殊词符！',1),
